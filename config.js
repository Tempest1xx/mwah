...
window.SITE_CONFIG = {
  ...
  passcodeHint: "hint: It's the thing that we both say a lot",
  ...
  memories: [
    { date: "", title: "How it started", text: "It started cause it was destined, A simple touney where i came 2nd but still won" },
    { date: "", title: "A favorite day", text: "I would honestly call out best day the day where i saw botman getting blocked YES" },
    { date: "", title: "A small, ordinary moment", text: "Our first video call, you dressing infront of me i loved it so much and i still do" },
